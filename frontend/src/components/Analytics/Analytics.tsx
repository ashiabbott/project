...
const Analytics: React.FC = () => {
  ...
  const tabs = [
    { name: 'Spending Trends', icon: <TrendingUpIcon className="w-5 h-5" /> },
    { name: 'Income vs Expenses', icon: <CashIcon className="w-5 h-5" /> },
    { name: 'Category Breakdown', icon: <ChartPieIcon className="w-5 h-5" /> },
    { name: 'Financial Health', icon: <CreditCardIcon className="w-5 h-5" /> },
  ];
